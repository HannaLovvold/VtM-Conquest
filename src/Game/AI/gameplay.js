...
const MILITARY_ACTION_PATTERN =
  /\b(troop|army|armies|attack|invade|invasion|deploy|siege|offensive|coterie|hounds|proxies|retainers|sorcery|havenguard|blood hunt|strike|ambush|kidnap|assassin)/i;
...
const buildMilitaryFeasibilityText = (world, actionsText) => {
  ...
  return [
    ...
    "- Unit type: proxies (deniable mortal assets — police, hitmen, press) reach farthest and move fastest but cannot hold ground against Kindred; hounds (war ghouls and beasts) hit hard at close range; coteries (Kindred cells) are the versatile baseline; sorcery covens strike at long range but are fragile up close; retainers are feeding and logistics networks, near-helpless in a fight; havenguard never travel — they defend a haven or court.",
