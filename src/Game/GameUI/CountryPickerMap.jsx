...
const withAlpha = (hex, alpha) => {
  ...
  if (!m) return `rgba(138,3,3,${alpha})`;
...
const CountryPickerMap = ({
  ...
  useEffect(() => {
    ...
    const styleFn = (feature) => {
        ...
        return new Style({
          fill: new Fill({
            color: isSelected
              ...
              : isHovered ? "rgba(138,3,3,0.28)" : "rgba(40,32,28,0.3)",
          }),
          stroke: new Stroke({
            color: isSelected ? withAlpha(selectionColorRef.current, 0.95) : "rgba(232,221,200,0.4)",
      ...
      if (!isPlayable) {
        return new Style({
          fill: new Fill({ color: "rgba(40,32,28,0.35)" }),
          stroke: new Stroke({
            color: "rgba(232,221,200,0.25)",
            width: 0.6,
          }),
        });
      }
      ...
      return new Style({
        fill: new Fill({
          color: isHovered ? "rgba(138,3,3,0.55)" : codeToColor(code),
        }),
        stroke: new Stroke({
          color: isHovered
            ? "rgba(138,3,3,0.9)"
            : "rgba(232,221,200,0.3)",
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
      ...
      >
        ...
        {filteredOptions.length > (query.trim() ? 30 : 12) && (
          <div style={{ color: "rgba(232,221,200,0.45)", fontSize: "0.72rem", padding: "0.3rem", textAlign: "center" }}>
