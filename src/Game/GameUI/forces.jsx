...
import { SURFACE, BORDER, TEXT, FONT_UI } from "./theme";
...
const UnitRow = ({ unit, dimmed, onClick }) => (
  ...
  >
    ...
    <div style={{ minWidth: 0, flex: 1 }}>
      ...
      <div style={{ fontSize: "10px", color: "rgba(232,221,200,0.55)" }}>
...
export const ForcesPanel = ({ mapRef, topOffset = "0px", open = false, onToggle }) => {
  ...
  const [deployType, setDeployType] = useState("coterie");
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
            ...
            <button
              ...
              style={{ background: "none", border: "none", color: "rgba(232,221,200,0.6)", cursor: "pointer", fontSize: "14px" }}
            >
              ✕
            </button>
          </div>
          ...
          {/* Deploy controls */}
          <div style={{ background: "rgba(232,221,200,0.05)", borderRadius: "8px", padding: "8px", marginBottom: "10px" }}>
            <div style={{ fontSize: "11px", color: "rgba(232,221,200,0.6)", marginBottom: "6px" }}>Deploy a unit</div>
            <div style={{ display: "flex", gap: "5px", marginBottom: "6px" }}>
              <select
                value={deployType}
                onChange={(e) => setDeployType(e.target.value)}
                style={{ flex: 1, background: "rgba(0,0,0,0.3)", color: TEXT, border: "1px solid rgba(232,221,200,0.15)", borderRadius: "6px", padding: "4px", fontSize: "12px" }}
              >
              ...
              <input
                ...
                title="Strength"
                style={{ width: "4rem", background: "rgba(0,0,0,0.3)", color: TEXT, border: "1px solid rgba(232,221,200,0.15)", borderRadius: "6px", padding: "4px", fontSize: "12px" }}
              />
            </div>
            <input
              type="text"
              ...
              style={{ width: "100%", boxSizing: "border-box", background: "rgba(0,0,0,0.3)", color: TEXT, border: "1px solid rgba(232,221,200,0.15)", borderRadius: "6px", padding: "4px", fontSize: "12px", marginBottom: "6px" }}
            />
            <button
              onClick={startDeploy}
              style={{ width: "100%", background: "rgba(138, 3, 3, 0.35)", border: "1px solid rgba(232,221,200,0.15)", borderRadius: "6px", color: TEXT, cursor: "pointer", fontSize: "12px", fontWeight: 600, padding: "6px 0" }}
            >
              Place on map →
            </button>
          </div>
          ...
          <div style={{ overflowY: "auto", flex: 1 }}>
            <div style={{ fontSize: "11px", color: "rgba(232,221,200,0.6)", margin: "0 0 5px" }}>
              Your units ({myUnits.length})
            </div>
            {myUnits.length === 0 && (
              <div style={{ fontSize: "11px", color: "rgba(232,221,200,0.35)", marginBottom: "8px" }}>
            ...
            {otherUnits.length > 0 && (
              <>
                <div style={{ fontSize: "11px", color: "rgba(232,221,200,0.6)", margin: "8px 0 5px" }}>
