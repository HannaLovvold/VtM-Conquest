      ...
      >
        <button
          ...
          style={{
            ...
            flexShrink: 0,
            padding: 0,
            color: status === "error" ? "#f87171" : "rgba(232,221,200,0.8)",
        ...
        <input
          ...
          style={{
            ...
            border: "none",
            outline: "none",
            color: status === "error" ? "#f87171" : TEXT,
            fontSize: "0.85rem",
            width: "100%",
        ...
        {expanded && (
          <button
            ...
            style={{
              ...
              padding: "0 0.6rem",
              height: "3rem",
              color: query.trim() ? "rgba(232,221,200,0.8)" : "rgba(232,221,200,0.2)",
              display: "flex",
              alignItems: "center",
              flexShrink: 0,
              transition: "color 0.2s",
            ...
            return (
              <div
                ...
                style={{
                  ...
                  gap: "0.55rem",
                  backgroundColor:
                    index === selectedIndex ? "rgba(138, 3, 3, 0.28)" : "transparent",
                  borderBottom:
                    index < suggestions.length - 1
                      ? "1px solid rgba(232,221,200,0.05)"
                      : "none",
