...
const ScenarioCard = ({
  ...
  return (
    ...
    style={{
      ...surfaceStyle,
      borderColor: active ? `${scenario.accentColor}66` : "rgba(232,221,200,0.08)",
          borderRadius: "24px",
          flex: "0 0 21rem",
          minHeight: "15rem",
          overflow: "hidden",
    ...
    <span
    style={{
      background: active ? `${scenario.accentColor}66` : "rgba(232,221,200,0.12)",
    ...
    style={{
      ...actionButtonStyle,
      background: active ? "rgba(232,221,200,0.16)" : `${scenario.accentColor}cc`,
          borderColor: active ? "rgba(232,221,200,0.22)" : `${scenario.accentColor}dd`,
          color: TEXT_BRIGHT,
          flex: 1,
    }}
    >
  ...
  return (
    ...
    {Object.entries(uploadLabels).map(([assetKey, label]) => (
      ...
      style={{
        ...actionButtonStyle,
        background: "rgba(232,221,200,0.03)",
                                                              color: assetStatus[assetKey] ? "rgba(232,221,200,0.92)" : "rgba(232,221,200,0.35)",
      }}
...
const ScenarioTopBar = () => {
  ...
  return (
    ...
    <div style={{ color: TEXT_BRIGHT, fontSize: "1rem", fontWeight: 800, letterSpacing: "-0.03em" }}>
    VtM Conquest
    </div>
    <div style={{ color: "rgba(232,221,200,0.48)", fontSize: "0.72rem", marginTop: "0.08rem" }}>
    ...
    {panelCards.slice(0, 6).map((scenario) => {
      ...
      return (
        ...
        style={{
          ...actionButtonStyle,
          background: active ? `${scenario.accentColor}55` : "rgba(232,221,200,0.05)",
              borderColor: active ? `${scenario.accentColor}88` : "rgba(232,221,200,0.08)",
              color: TEXT_BRIGHT,
              flexShrink: 0,
        }}
        >
    ...
    style={{
      ...actionButtonStyle,
      background: `${activeScenario?.accentColor ?? ACCENT}cc`,
      borderColor: `${activeScenario?.accentColor ?? ACCENT}dd`,
      color: TEXT_BRIGHT,
    }}
    >
    New Scenario
    ...
    {isPanelOpen && (
      ...
      >
      <div>
      <div style={{ color: TEXT_BRIGHT, fontSize: "1.45rem", fontWeight: 800, letterSpacing: "-0.04em" }}>
      {activeScenario?.heroTitle || activeScenario?.name || "Scenario Deck"}
      </div>
      <div style={{ color: "rgba(232,221,200,0.58)", fontSize: "0.9rem", marginTop: "0.2rem" }}>
      {activeScenario?.heroSubtitle || "Switch prompts, names, and PMTiles without cloning full saves."}
      </div>
      </div>
      <div style={{ color: "rgba(232,221,200,0.45)", fontSize: "0.8rem" }}>
