...
const WebGLWarningPopup = () => (
  ...
  >
    <div
      style={{
        backgroundColor: "rgba(22, 15, 13, 0.92)",
    ...
    >
      ...
      <p style={{ margin: "0 0 0.5rem", lineHeight: 1.6, color: "rgba(232,221,200,0.8)", fontSize: "0.95rem" }}>
        This application requires <strong style={{ color: "#f5eeda" }}>WebGL</strong> to render
        the map, but it doesn't appear to be supported or enabled in your browser.
      </p>
      <p style={{ margin: "0 0 1.5rem", lineHeight: 1.6, color: "rgba(232,221,200,0.6)", fontSize: "0.85rem" }}>
