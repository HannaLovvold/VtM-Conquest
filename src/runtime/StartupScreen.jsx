...
// Loading-screen artwork — the Club Masquerade key art. The preload check below
// skips any missing file, so the screen never flashes a broken image.
const LOADING_IMAGES = [
  "/loading_screen_vtm.jpg",
];
...
const StartupScreen = ({
    ...
    <style>{`
      *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .ss-logo {
        ...
        height: 3.6rem;
        object-fit: contain;
        filter: drop-shadow(0 0 10px rgba(192,32,32,0.5));
        animation: logoBreath 3.5s ease-in-out infinite;
        flex-shrink: 0;
      }

      @keyframes logoBreath {
        0%,100% { filter: drop-shadow(0 0 8px rgba(138,3,3,0.45)); }
        50%      { filter: drop-shadow(0 0 18px rgba(192,32,32,0.75)); }
      }
      ...
      .ss-game-name {
        ...
        color: rgba(192,32,32,0.75);
        text-shadow: 0 0 12px rgba(138,3,3,0.5);
      ...
      .ss-title {
        ...
        text-shadow: 0 2px 24px rgba(138,3,3,0.45), 0 0 60px rgba(0,0,0,0.8);
        line-height: 1;
      }
      ...
      .ss-step-counter {
        ...
        color: rgba(192,32,32,0.55);
        text-transform: uppercase;
      }

      /* Decorative thin blood-red rule */
      .ss-rule {
        width: 100%;
        height: 1px;
        background: linear-gradient(
          ...
          transparent 0%,
          rgba(138,3,3,0.25) 8%,
                                    rgba(160,16,16,0.55) 30%,
                                    rgba(192,32,32,0.75) 50%,
                                    rgba(160,16,16,0.55) 70%,
                                    rgba(138,3,3,0.25) 92%,
                                    transparent 100%
        );
      }
  ...
  box-shadow: 0 0 12px rgba(192,32,32,0.1);
  pointer-events: none;
      }
  ...
  animation: sweep 2.2s ease-in-out infinite;
      ...
      .ss-progress-head {
        ...
        border-radius: 50%;
        background: #e07070;
        box-shadow: 0 0 8px 3px rgba(192,32,32,0.7), 0 0 20px 6px rgba(138,3,3,0.4);
        pointer-events: none;
      ...
      .ss-dot-active  {
        background: rgba(192,32,32,0.95);
        box-shadow: 0 0 6px rgba(192,32,32,0.8);
      ...
      @keyframes dotPulse {
        0%,100% { box-shadow: 0 0 4px rgba(192,32,32,0.6); }
        50%      { box-shadow: 0 0 10px rgba(192,32,32,1); }
      }
      ...
      <img className="ss-logo" src="/logo.png" alt="VtM Conquest" />
      <div className="ss-title-block">
      <div className="ss-game-name">VtM Conquest</div>
