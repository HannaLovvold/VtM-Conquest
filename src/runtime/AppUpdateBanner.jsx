...
const bar = {
  ...
  background: "linear-gradient(180deg, #160d0d, #0a0605)",
...
export default function AppUpdateBanner() {
  ...
  const onUpdate = async () => {
    ...
    if (isWeb) {
      ...
      // (vtm-conquest-preload-*, ~160MB of PMTiles); wiping them would turn a code
  ...
  return (
    <div style={bar} role="status" aria-live="polite">
      <div style={text}>
        A new version of VtM Conquest is ready.
        <span style={sub}>
          {desktop
