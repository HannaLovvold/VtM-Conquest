  ...
  return (
    ...
    >
          ...
          {onApplyToScenario && (
            <button
              ...
              style={{
                ...
                gap: isMobile ? 0 : 6,
                background: applying ? "rgba(138,3,3,0.35)" : "rgba(138,3,3,0.85)",
      ...
      {d.activeTool === "paint" && (
        ...
        >
          <span style={{ color: "rgba(232,221,200,0.72)" }}>Paint owner</span>
          {d.colors[paintOwner] && (
            <span style={{ width: 16, height: 16, borderRadius: 4, border: "1px solid rgba(232,221,200,0.3)", background: `rgb(${d.colors[paintOwner].join(",")})` }} />
          )}
          <input
            value={paintOwner}
          ...
          />
          <span style={{ color: "rgba(232,221,200,0.4)" }}>click regions · empty = unowned</span>
        </div>
      )}
